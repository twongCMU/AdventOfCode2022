...
# hard coding the data was easier than writing a parser for it and then using it twice
items = {0:[73, 77],
         1:[57, 88, 80],
         2:[61, 81, 84, 69, 77, 88],
...
for i in range(10000):
    ...
    for m in range(8):
        ...
        while len(items[m]):
            ...
            # If new_v is higher than all of the test values multiplied together
            # we can just take the modulo as the new value and it is effectively
            # the same
            if new_v > (11*19*5*3*13*17*7*2):
                new_v = new_v % (11*19*5*3*13*17*7*2)
